class TripsController < ApplicationController
  ...
  def new
    ...
    start_time = DateTime.new(start_lst[2].to_i, start_lst[1].to_i, start_lst[0].to_i, 0, 0, 0)
    end_time = DateTime.new(end_lst[2].to_i, end_lst[1].to_i, end_lst[0].to_i, 0, 0, 0)
